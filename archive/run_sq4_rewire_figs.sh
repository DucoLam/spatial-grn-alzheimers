#!/bin/bash
#SBATCH --job-name=sq4_rewfigs
#SBATCH --partition=general
#SBATCH --qos=short
#SBATCH --cpus-per-task=8
#SBATCH --mem=48GB
#SBATCH --time=00:30:00
#SBATCH --output=/tudelft.net/staff-umbrella/ScReNI/dflam/slurm/logs/sq4_rewfigs_%j.out
#SBATCH --error=/tudelft.net/staff-umbrella/ScReNI/dflam/slurm/logs/sq4_rewfigs_%j.err
...
apptainer exec --writable-tmpfs --bind /tudelft.net:/tudelft.net --bind $HOME:$HOME \
  ...
  python -u /tudelft.net/staff-umbrella/ScReNI/dflam/archive/_sq4_rewire_figs.py
